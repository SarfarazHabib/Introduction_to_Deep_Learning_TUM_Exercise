...
class Solver(object):
    ...
    def _reset_histories(self):
        ...
        self.train_loss_history_per_epoch = [] #added
        self.train_loss_history_copy = [] #added
                ...
                if log_nth and i % log_nth == 0:
                    ...
                    print('[Iteration %d/%d] TRAIN loss: %.3f' % \
                        (i + epoch * iter_per_epoch,
                         ...
                         train_loss))
            self.train_loss_history_copy = self.train_loss_history.copy() #added
            self.train_loss_history_per_epoch.append(sum(self.train_loss_history_copy)/len(train_loader)) #added
            self.train_loss_history_copy.clear() #added
